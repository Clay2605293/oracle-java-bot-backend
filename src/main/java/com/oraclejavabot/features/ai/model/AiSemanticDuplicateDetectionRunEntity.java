...
@Entity
@Table(name = "AI_SEMANTIC_DUP_DETECTION_RUN")
public class AiSemanticDuplicateDetectionRunEntity {
    ...
    @Column(name = "DETECTION_ENGINE", nullable = false)
    ...
    public AiSemanticDuplicateDetectionRunEntity() {}
