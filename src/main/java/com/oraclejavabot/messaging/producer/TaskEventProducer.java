...
public class TaskEventProducer {
    ...
    public void sendUserAssignedEvent(String taskId, String userId) {
        UserAssignedEvent event = new UserAssignedEvent(taskId, userId);

        logger.info("Sending Kafka event to topic {}. taskId={}, userId={}",
                TASK_EVENTS_TOPIC, taskId, userId);

        try {
            SendResult<String, Object> result = kafkaTemplate
                    .send(TASK_EVENTS_TOPIC, taskId, event)
                    .get();
            ...
            logger.error("Error sending Kafka event. taskId={}, userId={}", taskId, userId, e);
