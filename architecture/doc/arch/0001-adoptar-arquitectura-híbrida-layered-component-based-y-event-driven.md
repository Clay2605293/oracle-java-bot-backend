...
Se descartó como estrategia inicial porque no se cuentan con los recursos económicos para desplegar una DB por servicio, además que aumentaría la complejidad de despliegue, observabilidad, contratos, versionamiento y operación. Para el alcance académico y estado actual del producto, sería sobredimensionado.
